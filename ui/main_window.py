...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.acceleration_chart.setBackgroundBrush(brush)
        ...
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.NoBrush)
        self.force_chart.setBackgroundBrush(brush)
        ...
        self.number_of_punche_line = QtWidgets.QLineEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.number_of_punche_line.sizePolicy().hasHeightForWidth())
        self.number_of_punche_line.setSizePolicy(sizePolicy)
        self.number_of_punche_line.setMaximumSize(QtCore.QSize(300, 16777215))
        self.number_of_punche_line.setReadOnly(True)
        self.number_of_punche_line.setObjectName("number_of_punche_line")
        self.gridLayout_3.addWidget(self.number_of_punche_line, 5, 1, 1, 1)
